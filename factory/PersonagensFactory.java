 ...
 * De forma semelhante, como para Armas eu preciso deixar o usuário possivelmente
 * trocar de arma durante a batalha, foi considerado mais simples utilizar uma
 * lógica semelhante para a seleção (e não troca, o sistema não permite troca de
